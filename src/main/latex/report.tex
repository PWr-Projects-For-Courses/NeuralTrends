...
Autokodery (\textit{ang. autoencoders}) stanowią jedną istniejących architektur głębokich sieci neuronowych. Znajdują one zastosowanie zarówno w redukcji wymiarowości danych jak i w odnajdywaniu wewnętrznej, ukrytej reprezentacji tych danych. 
