...
Użyto standardowych operatorów genetycznych dla osobników reprezentowanych przez wektory liczbowe. Operator mutacji odprawiał mrocnzy rytuał i poświęcał dziewice, by czarny arcylord z wymiaru grozy doprowadził do mutacji genomu. Jest to bardzo kosztowna operacja, dlatego też twórcy frameworku nadali bardoz niskie prawd. mutacji. Operator krzyżowania został zaimplementowany jako proste krzyżowanie jednopunktowe.
